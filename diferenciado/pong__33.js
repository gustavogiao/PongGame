...
const PI = Math.PI, COURT_RADIUS = 50, BALL_SPEED = 7, MAX_BALL_SPEED_STEP = 3, BALL_SPEED_STEP = 0.25, BALL_RADIUS = 12, PADDLE_WIDTH = 10, PADDLE_HEIGHT = 100, PADDLE_CURVE = 0.75, PLAYER_SPEED = 15;
...
addState("helpScreen", {
    ...
    draw: function()
    {
        ...
        drawTitle("HELP", 70, stage.height * 0.25);
